...
turnOnScreen_: public turnOnScreen_
	lda		#SpriteSize					; Enable 16K VRAM, Turn on screen, IRQ interrupt. Sprite size is set by SpriteSize define
	ora		#$E0
	sta		ZPParam1
	lda		#$01
	sta		ZPParam2
...
turnOffScreen_:	public turnOffScreen_
	lda		#SpriteSize					; Enable 16K VRAM, Turn off screen, IRQ interrupt. Sprite size is set by SpriteSize define
	ora		#$A0
	sta		ZPParam1
	lda		#$01
	sta		ZPParam2
